...
use Google\Cloud\Tasks\V2beta3\CloudTasksGrpcClient;
...
use Google\Cloud\Tasks\V2beta3\Task_View;
...
class CloudTasksGapicClient
{
     ...
     *          For allowed values, use constants defined on {@see \Google\Cloud\Tasks\V2beta3\Task_View}
     *     @type int $pageSize
     *          The maximum number of resources contained in the underlying API
     *          response. The API may return fewer values in a page, even if
     *          there are additional values to be retrieved.
